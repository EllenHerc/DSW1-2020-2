...
import br.ufscar.dc.dsw.controller.ImobiliariaController;
...
public class EmailService {
	...
	public void send(InternetAddress from, InternetAddress to, String subject, String body, File file) {
		...
		try {
			...
			InputStream is = ImobiliariaController.class.getClassLoader().getResourceAsStream("config.properties");
